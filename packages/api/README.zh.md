...
| [`workspace-git/`](workspace-git/README.zh.md) | 拥有 Session 工作区的 checkout——ref、worktree 目录与 GitHub 仓库——并通过 `workspaceGit` Remote namespace 提供。 | `ctx.workspaceGit` / `ctx.remote.workspaceGit` |
