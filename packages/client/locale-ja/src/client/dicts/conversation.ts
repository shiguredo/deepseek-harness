...
export const ja: LocaleDictOf<'conversation'> = {
  ...
  'tool.title.subagent': 'タスクを委任',
  'tool.title.listAgents': 'エージェントを一覧',
  ...
  'tool.title.waitAgent': 'チームメンバーを待機',
  ...
  'detail.wait.noProgress': 'アクティブなチームメンバーはいません',
  'detail.wait.title': 'チームメンバーのアクティビティ',
