...
type AttentionSnapshot = Parameters<Parameters<FontFamilyRowComponentProps['useSessionPendingInteraction']>[0]>[0]
const noAttention: AttentionSnapshot = new Map()
const useSessionPendingInteraction: FontFamilyRowComponentProps['useSessionPendingInteraction'] = selector => selector(noAttention)
